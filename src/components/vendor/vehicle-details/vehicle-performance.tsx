...
import { VendorVehicleDetails } from "@/types";
...
interface Props {
  performance: VendorVehicleDetails["performance"];
  bookings: VendorVehicleDetails["recentBookings"];
}

export default function VehiclePerformance({ performance, bookings }: Props) {
  const stats = [
    {
      label: "TOTAL REVENUE",
