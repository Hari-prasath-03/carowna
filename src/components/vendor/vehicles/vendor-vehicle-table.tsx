...
interface VendorVehicleTableProps {
...
export default function VendorVehicleTable({
  vehicles,
  total,
  currentPage,
  totalPages,
  ...
  return (
    <GenericTable
      header={{
        ...
        subtitle: `${total} TOTAL VEHICLES TRACKED`,
        renderRightSection: () => (
          <div className="flex items-center gap-3">
            ...
            <FormSelect
              ...
              containerClassName="w-[140px] gap-0 text-[10px]"
              options={[
      ...
      columns={[
        {
          ...
          render: (item) => (
            <div className="flex items-center gap-4">
              <div className="relative w-14 h-11 rounded-lg overflow-hidden bg-muted shrink-0 border border-border/20 shadow-sm">
                {item.images?.[0] ? (
                  <Image
                    src={item.images[0]}
                    alt={item.name}
        ...
        },
        {
          ...
          render: (item) => (
            <div className="flex items-center justify-end gap-1">
              ...
              <Link
                href={`/vendor/vehicles/${item.id}/edit`}
                className="p-2 hover:bg-muted/40 rounded-lg transition-colors inline-flex group"
              >
